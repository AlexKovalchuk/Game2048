...
public class Board_Move_Down_Tests
{
    [Fact]
    public void Down_Merges_Last_Pair_And_Spawns_Deterministically()
    {
        // Колонка 0: [0,0,2,2]^T
        ...
        // Після руху вниз маємо (3,0)=4.
        // Перша порожня по рядковому обходу — (0,0) => індекс 0.
        var rng = new ScriptedRandom(
            ints:    new[] { 0 },   // spawn у (0,0)
        ...
        expected[3,0] = 4; // merge внизу
        expected[0,0] = 2; // spawn зверху
